    ...
    <div className="login-page">
      ...
      <div className="login-form-side">
        <div className="login-form-container">
          ...
          <p className="text-body-sm">{isSignUp ? 'Join your community today' : 'Sign in to your account to continue'}</p>
          ...
          <form className="login-form" onSubmit={handleAuthSubmit}>
            ...
            <button type="submit" disabled={isLoggingIn} className="btn btn-primary w-full" style={{ width: '100%', padding: '14px', marginTop: isSignUp ? '24px' : '0' }}>
          ...
          <div className="social-login">
            <button onClick={handleGoogleLogin} type="button" disabled={isLoggingIn} className="social-btn" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', background: 'transparent', border: '1px solid var(--border)', width: '100%' }}>
            ...
            <button type="button" disabled={isLoggingIn} className="social-btn" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', background: 'transparent', border: '1px solid var(--border)', width: '100%' }}>
